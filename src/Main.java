public class Main{
	public static void main(String[] args){
		...
		String MqttServer1       = "tcp://broker.hivemq.com:1883";
		...
		MQTT ReadFromOtherMQTT = new MQTT(MqttServer1, client_id, username, passwd); 
		...
		ReadFromOtherMQTT.publish("test1111",0);
